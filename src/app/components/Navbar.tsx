...
export default function Navbar() {
  ...
  return (
    <nav className="fixed inset-0 top-1 z-20">
      <div className="mx-auto w-full max-w-[1540px] px-4">
        <div className="gradient-background fixed left-1/2 z-30 mx-auto mt-1 flex h-[70px] w-[98%] max-w-[1540px] -translate-x-1/2 items-center justify-between rounded-full border-[0.5px] border-neutral-300 px-4 shadow-2xl md:mt-1.5 md:w-[95%]">
          <Link
            href="/"
