...
export default function Navbar() {
  ...
  return (
    <nav className="fixed left-1/2 z-30 mx-auto mt-1 flex h-[70px] w-[98%] max-w-[1540px] -translate-x-1/2 items-center justify-between rounded-full bg-[#C1121F] px-4 shadow-2xl md:mt-4 md:w-[95%]">
      <Link
        href="/"
